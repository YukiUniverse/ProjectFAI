    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0 p-3 text-center bg-white h-100">
                ...
                <a href="{{ route('admin.laporan-mahasiswa') }}" class="btn btn-outline-success btn-sm mt-2" disabled>🎓
                    Data Master</a>
            </div>
        </div>
    </div>
                    ...
                    <div style="max-height: 400px; overflow-y: auto;">
                        <table class="table table-hover mb-0" id="tableLog">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4">Belum ada pendaftaran baru.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="text-truncate" style="max-width: 150px;"
                                                title="{{ $kpi->activity_name }}">
                                                {{ $kpi->activity_name }}
                                            </div>
                                            <small
                                                class="text-muted">{{ $kpi->end_datetime ? $kpi->end_datetime->format('d M Y') : '-' }}</small>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="2" class="text-center py-4 text-muted">Belum ada acara selesai.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="card-footer bg-white text-center">
                    <a href="{{ route('admin.acara-list', ['status' => 'finished']) }}"
                        class="btn btn-sm btn-link text-decoration-none">Lihat Laporan Lengkap →</a>
                </div>
            </div>
        </div>
    </div>
