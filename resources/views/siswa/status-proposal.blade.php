            ...
            <div class="card-body">
                ...
                @if($proposals->isEmpty())
                    <div class="text-center py-5">
                        ...
                        <a href="{{ route('siswa.proposal-ajukan') }}" class="btn btn-outline-primary mt-2">Buat Proposal
                            Pertama</a>
                    </div>
                @else
                    <div class="table-responsive">
                        <table class="table data_table table-bordered align-middle table-hover">
                                ...
                                @foreach($proposals as $proposal)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($proposal->status == 'rejected')
                                                <div
                                                    class="alert alert-danger p-1 mb-0 small border-0 bg-danger bg-opacity-10 text-danger">
